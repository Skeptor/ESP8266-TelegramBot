...
class TelegramBOT
{
  public:
    ...
    void sendPhoto(String chat_id, String photo, String caption = "", String reply_markup = "");
    void SendAnimation(String chat_id, String animation, String caption = "", String reply_markup = "");
